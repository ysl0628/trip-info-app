...
export const ITINERARY: DayItinerary[] = [
  ...
  },
  {
    ...
    transport: [
      "哈仙達崗住宿 → 長灘（約 45-60 分鐘）",
      "長灘 → 杭廷頓海灘（約 25-35 分鐘）",
      "杭廷頓海灘 → 爾灣／橙縣 Mall 一帶（約 20-35 分鐘）",
      "爾灣／橙縣 Mall → 安大略機場還車（約 35-50 分鐘）",
      "還車後搭車回 Airbnb（約 30-45 分鐘）",
    ],
    mapLink:
      "https://www.google.com/maps/dir/1251+Marchmont+Avenue,+Hacienda+Heights,+CA+91745/Long+Beach+CA/Huntington+Beach+CA/Irvine+Spectrum+Center/3450+E+Airport+Dr+Suite+100,+Ontario,+CA+91745/1251+Marchmont+Avenue,+Hacienda+Heights,+CA+91745",
    timeline: [
      {
        time: "8:30-9:30 AM",
        period: "上午",
      ...
      },
      {
        ...
        duration: "約 45-60 分鐘",
        mapLink:
          "https://www.google.com/maps/dir/1251+Marchmont+Avenue,+Hacienda+Heights,+CA+91745/Long+Beach+CA",
        description: ["自駕前往 Long Beach Waterfront 一帶"],
      },
      {
        ...
        parkingCost: "停車 $2-5/小時",
        description: [
          "Long Beach Waterfront、Shoreline Village 走走",
          {
            text: "推薦景點: 瑪麗皇后號",
            link: "https://maps.app.goo.gl/y8kQYn1BxjzF9Nhr6",
          },
          {
            text: "推薦甜點: & Waffle",
            link: "https://maps.app.goo.gl/1RwHq4onCW9EzsnR7",
          },
      ...
      },
      {
        ...
        duration: "約 25-35 分鐘",
        mapLink:
          "https://www.google.com/maps/dir/Long+Beach+Waterfront+CA/Huntington+Beach+CA",
        description: ["或可以只在長灘逛逛，沿海岸公路前往 Huntington Beach"],
      },
      {
        time: "12:35-2:00 PM",
        period: "下午",
      ...
      },
      {
        ...
        duration: "約 20-35 分鐘",
        mapLink:
          "https://www.google.com/maps/dir/Huntington+Beach+CA/Irvine+Spectrum+Center",
        description: ["前往爾灣與鄰近橙縣購物區"],
      },
      {
        time: "2:35-4:15 PM",
        period: "下午",
    ...
    timeline: [
      {
        ...
        from: "哈仙達崗住宿",
        to: "上島大酒樓",
        mapLink: "https://maps.app.goo.gl/8MMtZtMtg3jo341V7",
        duration: "約 15 分鐘",
        luggage: "有行李",
