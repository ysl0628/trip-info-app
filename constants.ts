...
export const ITINERARY: DayItinerary[] = [
  ...
  },
  {
    ...
    title: "藝術、海灘與市集之旅",
    description:
      "上午兩種走法擇一：選項一為蓋蒂中心（Optional）後往聖莫尼卡；選項二為聖莫尼卡再往馬里布海灘。傍晚皆至農夫市場採買，晚上回 Airbnb 自煮晚餐。",
    highlights: [
      "蓋蒂中心 Getty Center（選項一／Optional）",
      "Santa Monica／Malibu（擇一路線）",
    ...
    timeline: [
      ...
      },
      {
        ...
        description: ["Optional：建築、花園、景觀；若想多留在海灘可縮短參觀或略過，直接開往聖莫尼卡。"],
      },
      {
        time: "12:10-12:50 PM",
        period: "上午",
      ...
      },
      {
        ...
        isFreeAdmission: true,
        parkingCost: "$2 - $3.5",
        description: ["選項二第一段：碼頭與海灘、Promenade", "導航 Parking Structure 6 或 8；前 90 分鐘免費等方案"],
      },
      {
        time: "12:30-1:10 PM",
        period: "下午",
      ...
      },
      {
        ...
        description: ["海灘散步、Malibu Pier", "周邊餐廳可選：Moonshadows、Malibu Farm Pier Cafe"],
      },
      {
        time: "12:50-3:20 PM",
        period: "下午",
      ...
      },
      {
        ...
        location: "煮晚餐",
        activityDuration: "約45分鐘",
        description: ["使用農夫市場採買的食材", "Airbnb 廚房"],
      },
      {
        time: "7:55-8:40 PM",
        period: "晚上",
    ...
    mapLink:
      "https://www.google.com/maps/dir/1251+Marchmont+Avenue,+Hacienda+Heights,+CA+91745/The+Getty+Center/Santa+Monica+Pier/Malibu+Beach+CA/The+Original+Farmers+Market/1251+Marchmont+Avenue,+Hacienda+Heights,+CA+91745",
  },
  {
    day: 3,
    date: "4/3 (週四)",
  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: ["海鮮、早午餐或主街咖啡輕食，依當天位置選店"],
      },
      {
        time: "2:00-4:00 PM",
        period: "下午",
